...
public final class UserGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<via.sep3.databaseserver.protobuff.LicenseMessage,
      via.sep3.databaseserver.protobuff.NullMessage> getUpdateLicenseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updateLicense",
      requestType = via.sep3.databaseserver.protobuff.LicenseMessage.class,
      responseType = via.sep3.databaseserver.protobuff.NullMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<via.sep3.databaseserver.protobuff.LicenseMessage,
      via.sep3.databaseserver.protobuff.NullMessage> getUpdateLicenseMethod() {
    io.grpc.MethodDescriptor<via.sep3.databaseserver.protobuff.LicenseMessage, via.sep3.databaseserver.protobuff.NullMessage> getUpdateLicenseMethod;
    if ((getUpdateLicenseMethod = UserGrpc.getUpdateLicenseMethod) == null) {
      synchronized (UserGrpc.class) {
        if ((getUpdateLicenseMethod = UserGrpc.getUpdateLicenseMethod) == null) {
          UserGrpc.getUpdateLicenseMethod = getUpdateLicenseMethod =
              io.grpc.MethodDescriptor.<via.sep3.databaseserver.protobuff.LicenseMessage, via.sep3.databaseserver.protobuff.NullMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class UserImplBase implements io.grpc.BindableService {
    ...
    public void updateLicense(via.sep3.databaseserver.protobuff.LicenseMessage request,
        io.grpc.stub.StreamObserver<via.sep3.databaseserver.protobuff.NullMessage> responseObserver) {
  ...
  public static final class UserBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserBlockingStub> {
    ...
    /**
     */
    public via.sep3.databaseserver.protobuff.NullMessage updateLicense(via.sep3.databaseserver.protobuff.LicenseMessage request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class UserFutureStub extends io.grpc.stub.AbstractFutureStub<UserFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<via.sep3.databaseserver.protobuff.NullMessage> updateLicense(
